...
then
      ...
      template4realm="keycloak/realm-templates/TENANT_REALM_TEMPLATE-export.json"
      template4connector="keycloak/realm-templates/TENANT_REALM_TEMPLATE-connector.json"
