...
Helper function to sort (recursively) and trim JSON (for debugging or testing).

Used to check which string is generated from given JSON data for hashing.

### Helper: Generate hash from JSON
